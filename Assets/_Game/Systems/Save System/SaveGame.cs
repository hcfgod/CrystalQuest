...
namespace SaveSystem
{
    ...
    public static class SaveGame
    {
        ...
        public static void Save(string identifier, object value, SaveGameSettings settings)
        {
            ...
            if (value == null)
            {
                Debug.LogWarning("Save System: Can't Save a null value");
                return;
            }
            if (!settings.Formatter.IsTypeSupported(value.GetType()))
            {
                Debug.LogWarningFormat("Save System: The serialization of type {0} isn't supported.", value.GetType());
                return;
            }
        ...
        public static object Load(string identifier, Type type, object defaultValue, SaveGameSettings settings)
        {
            ...
            if (!Exists(settings.Identifier, settings))
            {
                if (defaultValue == null)
                {
                    Debug.LogWarning("Save System: The specified identifier does not exists, please make sure the identifeir is exist before loading. The Default value is not specified, it might make exceptions and errors.");
                }
                else
                {
                    Debug.LogWarning("Save System: The specified identifier does not exists, please make sure the identifeir is exist before loading. Returning default value.");
                }
                return defaultValue;
            }
        ...
        public static void LoadInto(string identifier, object value, SaveGameSettings settings)
        {
            ...
            if (!Exists(settings.Identifier, settings))
            {
                Debug.LogWarning("Save System: The specified identifier does not exists.");
                return;
            }
            settings.Storage.OnLoad(settings);
