...
namespace KWS
{
    public partial class WaterSystem
    {
        ...
        internal List<ThirdPartyAssetDescription> ThirdPartyFogAssetsDescription = new List<ThirdPartyAssetDescription>()
        {
            ...
            new ThirdPartyAssetDescription(){EditorName = "Enviro 3", ShaderDefine = "ENVIRO_3_FOG", ShaderInclude = "FogIncludeHLSL.hlsl", DrawToDepth = true, IgnoreInclude = true},
            new ThirdPartyAssetDescription(){EditorName = "Azure", ShaderDefine                     = "AZURE_FOG", ShaderInclude               = "AzureFogCore.cginc"},
            new ThirdPartyAssetDescription(){EditorName = "Atmospheric height fog", ShaderDefine    = "ATMOSPHERIC_HEIGHT_FOG", ShaderInclude  = "AtmosphericHeightFog.cginc", CustomQueue = 3002},
           ...
           new ThirdPartyAssetDescription(){EditorName = "COZY Weather", ShaderDefine = "COZY_FOG", ShaderInclude = "StylizedFogIncludes.cginc", CustomQueue = 3002},
           new ThirdPartyAssetDescription(){EditorName = "COZY Weather 2", ShaderDefine = "COZY_FOG", ShaderInclude = "StylizedFogIncludes.cginc", CustomQueue = 3003}
        };
