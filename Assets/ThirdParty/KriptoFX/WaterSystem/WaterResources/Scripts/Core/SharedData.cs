...
namespace KWS
{
    public class SharedData
    {
        ...
        /////////////////// volumetric light ///////////////////////////
        internal KWS_RTHandle VolumetricLightingRT;
        ////////////////////////////////////////////////////////////////
        ...
        internal KWS_RTHandle SsrReflection;
        ////////////////////////////////////////////////////////////////
        ...
        internal RenderTexture FoamRawRT;
        ////////////////////////////////////////////////////////////////
        ...
        public void UpdateShaderParams(CommandBuffer cmd, PassEnum pass, ComputeShader cs, int kernel)
        {
                switch (pass)
                {
                    ...
                    case PassEnum.PlanarReflection:
                        cmd.SetComputeTextureParam(cs, kernel, KWS_ShaderConstants.ReflectionsID.KWS_PlanarReflectionRT, PlanarReflectionRaw.GetSafeTexture());
                        break;
