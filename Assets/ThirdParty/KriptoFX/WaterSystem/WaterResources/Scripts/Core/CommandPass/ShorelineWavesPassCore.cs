...
namespace KWS
{
    ...
    {
        public Action<CommandBuffer, Camera, RenderTexture, RenderTexture> OnSetRenderTarget;
        ...
        private RenderTexture _displacementRT, _normalRT;
        ...
        public override void Release()
        {
            ...
            KW_Extensions.SafeDestroy(_displacementRT, _normalRT);
        ...
        void InitializeTextures(int size)
        {
            ...
            {
                _displacementRT = new RenderTexture(size, size, 0, GraphicsFormat.R16G16B16A16_SFloat) { name = "_displacement" };
                _normalRT = new RenderTexture(size, size, 0, GraphicsFormat.R16G16_SFloat) { name = "_norm" };
