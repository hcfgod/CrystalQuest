...
namespace KWS
{
    ...
    {
        public Action<CommandBuffer, Camera, RenderTexture> OnInitializedRenderTarget;
        RenderTexture _planarFinalRT;
        ...
        void ReinitializeTextures(int size, GraphicsFormat graphicsFormat)
        {
            ...
            _planarFinalRT = new RenderTexture(size, size, 0, graphicsFormat, 5) { name = "_planarFilteredRT", useMipMap = true, autoGenerateMips = true };
