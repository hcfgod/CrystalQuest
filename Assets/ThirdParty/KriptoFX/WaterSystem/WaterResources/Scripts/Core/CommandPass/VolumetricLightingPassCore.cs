...
namespace KWS
{
    ...
    {
        public Action<CommandBuffer, Camera, KWS_RTHandle> OnSetRenderTarget;

        public KWS_RTHandle _volumeLightRT_Blured;
        public KWS_RTHandle _volumeLightRT;
        public KWS_RTHandle _volumeLightRT_Temp;
        public KWS_RTHandle _lowResDepthRT;
        ...
        public void InitializeTextures()
        {
            ...
            _volumeLightRT = KWS_RTHandles.AllocVR(ComputeRTHandleSize, name: "_volumeLightRT", colorFormat: GraphicsFormat.R16G16B16A16_SFloat);
            _volumeLightRT_Blured = KWS_RTHandles.AllocVR(ComputeRTHandleSizeBlured, name: "_volumeLightRT_Blured", colorFormat: GraphicsFormat.R16G16B16A16_SFloat);
            if (WaterInstance.Settings.VolumetricLightFilter == WaterSystem.VolumetricLightFilterEnum.Bilateral)
            {
                _volumeLightRT_Temp = KWS_RTHandles.AllocVR(ComputeRTHandleSize, name: "_volumeLightRT_Temp", colorFormat: GraphicsFormat.R16G16B16A16_SFloat);
                _lowResDepthRT = KWS_RTHandles.AllocVR(ComputeRTHandleSize, name: "_lowResDepthRT", colorFormat: GraphicsFormat.R32_SFloat);
            }
