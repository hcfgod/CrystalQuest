    ...
    public class DrawMeshPassCore: WaterPassCore
    {
        ...
        private void DrawInstancedQuadTree(CommandBuffer cmd)
        {
            ...
            if (WaterInstance.Settings.WaterMeshType == WaterSystem.WaterMeshTypeEnum.FiniteBox)
            {
                ...
                //var cornerFixRelativeToWind = WaterInstance.IsCameraUnderwater
                //    ? new Vector3(0, 0.05f + Mathf.Lerp(0, 0.15f, WaterInstance.Settings.WindSpeed / 15f))
                //    : Vector3.zero;
                ...
                cmd.DrawMesh(underwaterMesh, matrix, _waterMaterial, 0, (int)WaterMaterialPasses.WaterSide);
            }
        }
