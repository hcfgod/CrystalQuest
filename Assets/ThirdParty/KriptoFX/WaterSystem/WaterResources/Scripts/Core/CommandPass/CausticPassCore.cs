...
namespace KWS
{
    ...
    {
        public Action<CommandBuffer, RenderTexture> OnRenderToCausticTarget;
        ...
        class CausticData
        {
            ...
            public RenderTexture[] Lods = new RenderTexture[4];
            ...
            public void InitializeTextures(WaterSystem waterInstance)
            {
                ...
                {
                    Lods[i] = new RenderTexture(size, size, 0, GraphicsFormat.R8_UNorm, 4) {name = "_causticLod" + i, useMipMap = true, autoGenerateMips = true};
        ...
        void RenderLod(WaterSystem waterInstance, Material passMaterial, CommandBuffer cmd, Vector3 camPos, Vector3 camDir, float lodSize, RenderTexture target)
        {
