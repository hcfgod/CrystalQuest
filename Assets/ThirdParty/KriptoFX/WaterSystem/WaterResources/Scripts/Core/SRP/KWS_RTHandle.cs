...
namespace KWS
{
    ...
    /// <seealso cref="KWS_RTHandleSystem"/>
    /// </summary>
    public class KWS_RTHandle
    {
        internal KWS_RTHandleSystem m_Owner;
        ...
        internal KWS_RTHandle(KWS_RTHandleSystem owner)
        {
            m_Owner = owner;
        }
        ...
        public static implicit operator RenderTargetIdentifier(KWS_RTHandle handle)
        {
        ...
        public static implicit operator Texture(KWS_RTHandle handle)
        {
        ...
        public static implicit operator RenderTexture(KWS_RTHandle handle)
        {
        ...
        {
            m_Owner.Remove(this);
            KWS_SPR_CoreUtils.Destroy(m_RT);
