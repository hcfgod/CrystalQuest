...
namespace KWS
{
    ...
    public static class KWS_SPR_CoreUtils
    {
        ...
        public static void SetRenderTarget(CommandBuffer cmd, RenderTargetIdentifier buffer, Vector2 viewPortSize, ClearFlag clearFlag, Color clearColor, int miplevel = 0, CubemapFace cubemapFace = CubemapFace.Unknown, int depthSlice = -1)
        {
        ...
        public static void SetRenderTarget(CommandBuffer cmd, RenderTargetIdentifier colorBuffer1, RenderTargetIdentifier colorBuffer2, RenderTargetIdentifier depthBuffer, ClearFlag clearFlag, Color clearColor, int miplevel = 0, CubemapFace cubemapFace = CubemapFace.Unknown, int depthSlice = -1)
        {
            _tempRtIdentifiers[0] = colorBuffer1;
            _tempRtIdentifiers[1] = colorBuffer2;
            depthSlice = FixupDepthSlice(depthSlice, cubemapFace);
            cmd.SetRenderTarget(_tempRtIdentifiers, depthBuffer, miplevel, cubemapFace, depthSlice);
            ClearRenderTarget(cmd, clearFlag, clearColor);
        }
        ...
        private static void SetViewportAndClear(CommandBuffer cmd, Vector2 viewPortSize, ClearFlag clearFlag, Color clearColor)
        {
#if !UNITY_EDITOR
        ...
        static RenderTargetIdentifier[] _tempRtIdentifiers = new RenderTargetIdentifier[2];
        public static void SetRenderTarget(CommandBuffer cmd, KWS_RTHandle colorBuffer1, KWS_RTHandle colorBuffer2, KWS_RTHandle depthBuffer, ClearFlag clearFlag, Color clearColor, int miplevel = 0, CubemapFace cubemapFace = CubemapFace.Unknown, int depthSlice = -1)
        {
            _tempRtIdentifiers[0] = colorBuffer1;
            _tempRtIdentifiers[1] = colorBuffer2;
            SetRenderTarget(cmd, _tempRtIdentifiers, depthBuffer, clearFlag, clearColor, miplevel, cubemapFace, depthSlice);
            SetViewportAndClear(cmd, colorBuffer1, clearFlag, clearColor);
        }
