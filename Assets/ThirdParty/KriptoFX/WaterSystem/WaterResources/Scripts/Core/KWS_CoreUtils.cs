...
namespace KWS
{
    public static partial class KWS_CoreUtils
    {
        ...
        [Serializable] public struct Uint2 { public uint X; public uint Y; }
        [Serializable] public struct Uint3 { public uint X; public uint Y; public uint Z; }
        [Serializable] public struct Uint4 { public uint X; public uint Y; public uint Z; public uint W; }
        ...
        //public static void SetFloats(this WaterSystem waterInstance, bool requireUpdateComputeShaders = false, params (int key, float value)[] waterParams)
        //{
        //    SetFloats(waterInstance, null, requireUpdateComputeShaders, waterParams);
        //}

        //public static void SetFloats(this WaterSystem waterInstance, CommandBuffer cmd, bool requireUpdateComputeShaders = false, params (int key, float value)[] waterParams)
        //{
        //    // if (WaterSystem.VisibleWaterInstances.Count > 1)
        //    {
        ...
        //            foreach (var param in waterParams) waterMaterial.SetFloat(param.key, param.value);
        //        }
        //        if (requireUpdateComputeShaders) UpdateComputeShaderFloats(waterInstance, null, waterParams);
        //    }
        //    //else
        //    //{
        //    //    if (cmd != null)
        //    //    {
        //    //        foreach (var param in waterParams) cmd.SetGlobalFloat(param.key, param.value);

        //    //        if (requireUpdateComputeShaders) UpdateComputeShaderFloats(waterInstance, cmd, waterParams);
        //    //    }
        //    //    else
        //    //    {
        //    //        foreach (var param in waterParams) Shader.SetGlobalFloat(param.key, param.value);
        ...
        //private static void UpdateComputeShaderFloats(WaterSystem waterInstance, CommandBuffer cmd, params (int key, float value)[] waterParams)
        //{
        //    var waterComputeShaders = waterInstance.GetWaterRenderingComputeShaders();
        //    foreach (var cs in waterComputeShaders)
        //    {
        //        if (cs.Key == null) continue;
        //        foreach (var param in waterParams)
        //        {
        //            if (cmd == null)
        //                cs.Key.SetFloat(param.key, param.value);
        //            else
        //                cmd.SetComputeFloatParam(cs.Key, param.key, param.value);

        //        }
        //    }
        //}

        //public static void SetInts(this WaterSystem waterInstance, bool requireUpdateComputeShaders = false, params (int key, int value)[] waterParams)
        //{
        //    SetInts(waterInstance, null, requireUpdateComputeShaders, waterParams);
        //}

        //public static void SetInts(this WaterSystem waterInstance, CommandBuffer cmd, bool requireUpdateComputeShaders = false, params (int key, int value)[] waterParams)
        //{
        //    // if (WaterSystem.VisibleWaterInstances.Count > 1)
        //    //{
        //    var waterMaterials = waterInstance.GetWaterRenderingMaterials();
        ...
        //    {
        //        if (waterMaterial == null) continue;
        //        foreach (var param in waterParams) waterMaterial.SetInt(param.key, param.value);
        //    }
        //    if (requireUpdateComputeShaders) UpdateComputeShaderInts(waterInstance, null, waterParams);
        //    //}
        //    //else
        //    //{
        //    //    if (cmd != null)
        //    //    {
        //    //        foreach (var param in waterParams) cmd.SetGlobalInt(param.key, param.value);

        //    //        if (requireUpdateComputeShaders) UpdateComputeShaderInts(waterInstance, cmd, waterParams);
        //    //    }
        //    //    else
        //    //    {
        //    //        foreach (var param in waterParams) Shader.SetGlobalInt(param.key, param.value);
        ...
        //private static void UpdateComputeShaderInts(WaterSystem waterInstance, CommandBuffer cmd, params (int key, int value)[] waterParams)
        //{
        //    var waterComputeShaders = waterInstance.GetWaterRenderingComputeShaders();
        //    foreach (var cs in waterComputeShaders)
        //    {
        ...
        //        {
        //            if (cmd == null)
        //                cs.Key.SetInt(param.key, param.value);
        //            else
        //                cmd.SetComputeIntParam(cs.Key, param.key, param.value);

        //        }
        //    }
        //}

        //public static void SetVectors(this WaterSystem waterInstance, bool requireUpdateComputeShaders = false, params (int key, Vector4 value)[] waterParams)
        //{
        //    SetVectors(waterInstance, null, requireUpdateComputeShaders, waterParams);
        //}

        //public static void SetVectors(this WaterSystem waterInstance, CommandBuffer cmd, bool requireUpdateComputeShaders = false, params (int key, Vector4 value)[] waterParams)
        //{
        //    // if (WaterSystem.VisibleWaterInstances.Count > 1)
        //    //{
        //    var waterMaterials = waterInstance.GetWaterRenderingMaterials();
        ...
        //    {
        //        if (waterMaterial == null) continue;
        //        foreach (var param in waterParams) waterMaterial.SetVector(param.key, param.value);
        //    }
        //    if (requireUpdateComputeShaders) UpdateComputeShaderVectors(waterInstance, null, waterParams);
        //    //}
        //    //else
        //    //{
        //    //    if (cmd != null)
        //    //    {
        //    //        foreach (var param in waterParams) cmd.SetGlobalVector(param.key, param.value);

        //    //        if (requireUpdateComputeShaders) UpdateComputeShaderVectors(waterInstance, cmd, waterParams);
        //    //    }
        //    //    else
        //    //    {
        //    //        foreach (var param in waterParams) Shader.SetGlobalVector(param.key, param.value);
        ...
        //private static void UpdateComputeShaderVectors(WaterSystem waterInstance, CommandBuffer cmd, params (int key, Vector4 value)[] waterParams)
        //{
        //    var waterComputeShaders = waterInstance.GetWaterRenderingComputeShaders();
        //    foreach (var cs in waterComputeShaders)
        //    {
        ...
        //        {
        //            if (cmd == null)
        //                cs.Key.SetVector(param.key, param.value);
        //            else
        //                cmd.SetComputeVectorParam(cs.Key, param.key, param.value);

        //        }
        //    }
        //}

        //public static void SetTextures(this WaterSystem waterInstance, bool requireUpdateComputeShaders = false, params (int key, Texture value)[] waterParams)
        //{
        //    SetTextures(waterInstance, null, requireUpdateComputeShaders, waterParams);
        //}

        //public static void SetTextures(this WaterSystem waterInstance, CommandBuffer cmd, bool requireUpdateComputeShaders = false, params (int key, Texture value)[] waterParams)
        //{
        //    // if (WaterSystem.VisibleWaterInstances.Count > 1)
        //    {
        //        var waterMaterials = waterInstance.GetWaterRenderingMaterials();
        //        foreach (var waterMat in waterMaterials)
        //        {
        //            if (waterMat == null) continue;
        //            foreach (var param in waterParams) waterMat.SetTexture(param.key, param.value);
        //        }

        //        if (requireUpdateComputeShaders) UpdateComputeShaderTextures(waterInstance, null, waterParams);
        //    }
        //    //else
        //    //{
        //    //    if (cmd != null)
        //    //    {
        //    //        foreach (var param in waterParams) cmd.SetGlobalTexture(param.key, param.value);

        //    //        if (requireUpdateComputeShaders) UpdateComputeShaderTextures(waterInstance, cmd, waterParams);
        //    //    }
        //    //    else
        //    //    {
        //    //        foreach (var param in waterParams) Shader.SetGlobalTexture(param.key, param.value);
        ...
        //private static void UpdateComputeShaderTextures(WaterSystem waterInstance, CommandBuffer cmd, (int key, Texture value)[] waterParams)
        //{
        //    var waterComputeShaders = waterInstance.GetWaterRenderingComputeShaders();
        //    foreach (var cs in waterComputeShaders)
        //    {
        ...
        //        foreach (var param in waterParams)
        //        {
        //            var kernels = cs.Value;
        //            for (var kernelIdx = 0; kernelIdx < cs.Value.Length; kernelIdx++)
        //            {
        //                if (cmd == null)
        //                    cs.Key.SetTexture(kernels[kernelIdx], param.key, param.value);
        //                else
        //                    cmd.SetComputeTextureParam(cs.Key, kernels[kernelIdx], param.key, param.value);
        //            }
        //        }
        //    }
        //}
        ...
        public static RenderTexture GetSafeTexture(this KWS_RTHandle rtHandle, Color color = default)
        {
...
FilterMode filterMode = FilterMode.Bilinear, ShadowSamplingMode shadowSamplingMode = ShadowSamplingMode.None)
        ...
        public static void SetViewport(this CommandBuffer cmd, Rect viewPort, KWS_RTHandle target)
        {
            if (target.useScaling)
            {
        ...
        public static void SetViewportAndClear(this CommandBuffer cmd, Rect viewPort, KWS_RTHandle target, ClearFlag clearFlag, Color clearColor)
        {
#if !UNITY_EDITOR
        ...
        public static void BlitTriangleRTHandle(this CommandBuffer cmd, Rect viewPort, KWS_RTHandle target, Material mat, ClearFlag clearFlag, Color clearColor, int pass = 0)
        {
        ...
        public static void BlitTriangleRTHandle(this CommandBuffer cmd, KWS_RTHandle source, KWS_RTHandle target, Material mat, ClearFlag clearFlag, Color clearColor, int pass = 0)
        {
